...
import {
  ...
  rgba,
  withReset
} from "./chunk-O7TK3M3Q.js";
import {
  ActionBar
} from "./chunk-HRCJPWRQ.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-QKBC3DCI.js";
import {
  stringify
} from "./chunk-IQFNIFPU.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
...
var Photo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Images-S2WTXNGG-QPGWAZ3U.js");
...
var Book = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Documents-SGWAY3KW-AUFIBELK.js");
...
var Markup = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Editing-7QFB6ZMG-ZRC6PGO7.js");
...
var Repo = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Git-DZ2D5ZUL-VLNVW4RO.js");
...
var Apple = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./OS-YZ2Y4VYS-SXEZIXQ2.js");
...
var Storybook = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Logos-SJTNNI74-3VCUY5HP.js");
...
var Browser = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Devices-SUYACUPO-ZA66NP56.js");
...
var Edit = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./CRUD-I5EZL2FS-42UFIPRA.js");
...
var Info = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Communicate-7JXCND2Z-ICJLMEKX.js");
...
var ChevronUp = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./Wayfinding-BB4H7CHP-AFXDHNX7.js");
...
var User = withSuspense(
  (0, import_react25.lazy)(async () => {
    const m = await import("./People-OD4EV7WZ-H4AU4H7S.js");
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react27.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react27.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-QE55YTMA.js");
...
var LazyColorControl = (0, import_react27.lazy)(() => import("./Color-6VNJS4EI-V7O4KEO6.js"));
...
//# sourceMappingURL=chunk-YQRLFYOI.js.map
